...
const retrieveTool = tool(async ({ query }) => {
    ...
    name: 'retrieve',
    description: 'Retrieve the most relevant chunks of text from this fact database to use as context for answering questions.',
    schema: z.object({
        query: z.string(),
    })
});
...
app.post('/fact-check', async (req, res) => {
    try {
        ...
        Return JSON format: { "verdict": "True/False/Mixed", "confidence": 0-1, "explanation": [...concise...], "sources": [...links...] }`;
